...
HD_PWD='C:/Users/kmgrytte/thespinnerdood/thespinnerdood.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pos_seg7_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pos_seg7_ctrl.tcl -notrace
