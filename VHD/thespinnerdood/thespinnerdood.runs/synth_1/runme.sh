...
HD_PWD='C:/Users/kmgrytte/thespinnerdood/thespinnerdood.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pos_seg7_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pos_seg7_ctrl.tcl
